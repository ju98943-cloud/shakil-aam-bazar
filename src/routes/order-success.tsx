...
export const Route = createFileRoute("/order-success")({
  validateSearch: (s: Record<string, unknown>) => ({ o: (s.o as string) ?? "" }),
...
function SuccessPage() {
  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-20 text-center">
      ...
      {o && (
        <div className="mx-auto mt-6 inline-block rounded-xl border border-primary/30 bg-primary/5 px-6 py-3">
